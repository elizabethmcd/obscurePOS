...
inStrain profile $strainsPath/POS-2015-07-24-mapping.sorted.bam $genomePath/$genome.fa -o $outdir/$code.IS -p 8 -g $strainsPath/all-POS-genomes-genes.fna -s POS-scaffolds-to-bins.stb