...
metaPath2=$3
sample=$1
outdir=/home/GLBRCORG/emcdaniel/obscurePOS/metagenomes/assemblies/meta_assemblies/
...
# Run spades
/opt/bifxapps/bin/python3.4 $SPADESPATH/spades.py --meta  -k 21,33,55,77,99,127 -1 $metaPath1 -2 $metaPath2 -o $outdir/$sample